                ...
                <div className="mt-6 space-y-6">
                  <article className="rounded-[0.6rem] border-2 border-black/80 bg-white/70 p-4 sm:p-6">
                    <header className="flex flex-col gap-2 sm:flex-row sm:items-baseline sm:justify-between">
                      <div>
                        <h3 className="font-display text-2xl sm:text-3xl font-bold">Lead Software Engineer</h3>
                    ...
                    <p className="mt-3 text-sub text-black/85 leading-relaxed">
                      Led the end-to-end build of an OpenAI-powered writing platform, pairing rapid experimentation with production-ready delivery.
                    </p>
                    <ul className="mt-4 list-disc space-y-2 pl-5 text-sub text-black/80 leading-relaxed">
                      <li>Designed and shipped the core application leveraging OpenAI&apos;s API to elevate content quality and turnaround time.</li>
                      <li>Ran deep research cycles and A/B testing to tune workflows, raising efficiency and user satisfaction across the product.</li>
                      <li>Architected robust RESTful endpoints and multi-stage API chains so editors could orchestrate complex writing flows without friction.</li>
                      <li>Delivered a scalable Python (Flask) back end with a React front end, opting for modular microservices that keep future iterations flexible.</li>
                    </ul>
                  ...
                  <article className="rounded-[0.6rem] border-2 border-black/80 bg-white/70 p-4 sm:p-6">
                    <header className="flex flex-col gap-2 sm:flex-row sm:items-baseline sm:justify-between">
                      <div>
                        <h3 className="font-display text-2xl sm:text-3xl font-bold">Software Engineer (Co-op)</h3>
                        <p className="text-sub text-sm sm:text-base text-black/75">
                    ...
                    <p className="mt-3 text-sub text-black/85 leading-relaxed">
                      Contributed across the stack on ag-tech tooling, supporting sustainable farming initiatives with secure, scalable software.
                    </p>
                    <ul className="mt-4 list-disc space-y-2 pl-5 text-sub text-black/80 leading-relaxed">
                      <li>Built an internal front-end console that accelerated customer org provisioning in Azure with precise role and auth controls.</li>
                      <li>Developed an ngrok tunnel activation tool that bridged local developer functions with Azure event subscriptions to streamline workflows.</li>
                      <li>Helped transition the logging framework to Serilog, improving traceability and debugging clarity for the engineering team.</li>
                      <li>Implemented a JWT-based API to deliver SSO into Document360, simplifying knowledge access across the organization.</li>
                      <li>Scripted operational safeguards—including environment backups—using Bash to keep dev environments healthy.</li>
                      <li>Practiced Agile + DevOps fundamentals daily across Terraform, Docker, YAML pipelines, and the broader Azure ecosystem.</li>
                    </ul>
                    <p className="mt-4 text-xs uppercase tracking-wide text-black/60">
                      C# · .NET · Azure · Serilog · Terraform · Docker · JWT · Bash
                    </p>
                  </article>
                </div>
              </GlassBlock>
              ...
              <GlassBlock className="py-2 sm:p-8">
                ...
                <div className="mt-6 space-y-4">
                  <div className="rounded-[0.6rem] border-2 border-black/80 bg-white/70 p-4 sm:p-4">
                    <h3 className="font-display text-2xl sm:text-3xl font-bold">BCIT • Computer Systems Technology</h3>
                  ...
                  <div className="rounded-[0.6rem] border-2 border-black/80 bg-white/70 p-4 sm:p-4">
                    <h3 className="font-display text-2xl sm:text-3xl font-bold">Concordia University • BCom, Marketing</h3>
                    <p className="mt-1 text-sub text-sm sm:text-base font-semibold text-black/80 tracking-tight">
                      <span>2011 — 2015</span>
                      <span className="mx-2 font-normal text-black/70">•</span>
                ...
                <div className="mt-6 rounded-[0.6rem] border-2 border-black/80 bg-white/70 p-4 sm:p-6">
                  <ul className="grid gap-5 text-sub text-black/80 leading-relaxed sm:grid-cols-2">
                    <li className="flex flex-col">
                      <span className="font-display text-2xl font-bold text-black">English</span>
                      <span className="text-sm uppercase tracking-wide text-black/70">Fluent</span>
                    </li>
                    <li className="flex flex-col">
                      <span className="font-display text-2xl font-bold text-black">Bulgarian</span>
                      <span className="text-sm uppercase tracking-wide text-black/70">Fluent</span>
                    </li>
                    <li className="flex flex-col">
                      <span className="font-display text-2xl font-bold text-black">Russian</span>
                      <span className="text-sm uppercase tracking-wide text-black/70">Elementary</span>
                    </li>
                    <li className="flex flex-col">
                      <span className="font-display text-2xl font-bold text-black">Mandarin Chinese</span>
                      <span className="text-sm uppercase tracking-wide text-black/70">Beginner</span>
                    </li>
                  </ul>
                </div>
              </GlassBlock>
