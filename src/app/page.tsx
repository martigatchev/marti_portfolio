      ...
      <main>
        ...
        <div className="relative w-full max-w-none">
          <div className="relative w-full h-[100dvh] overflow-hidden">
            ...
            {/* <PixelMosaic className="w-full h-full" pixelSize={1} speed={0.4} noiseScale={1.5} contrast={1.5} palette={['#ffffffff', '#b48cff', '#a78bfa', '#ff9acb', '#ff6d98']} paletteMix={0.45} toneGamma={1.1} tint="var(--c-lilac)" tintAmount={1.5} edgeFeather={0.4} edgeMinAlpha={0.2} quality={1} /> */}
            ...
            <div className="pointer-events-none absolute inset-0 z-10 grid place-content-center px-4 text-center">
              <div className="flex flex-col items-center gap-3">
               ...
               drop-shadow-[0_2px_16px_rgba(255,255,255,0.00)]"
                >
                  {" "}
                  MARTI GATCHEV
                </h1>
