...
const DEFAULT_ITEMS: ExperienceItem[] = [
  {
    ...
    summary:
      "Built internal tooling and authentication flows for an ag-tech web platform, focusing on secure onboarding, developer velocity, and observability in Azure.",
    bullets: [
      "Shipped an org-setup console for Azure DB with role provisioning and user authentication.",
      "Implemented a JWT-based SSO gateway integrating Document360 with the web app.",
      "Streamlined dev workflows with an ngrok tunnel activator for Azure event subscriptions.",
    ],
  ...
  },
  {
    ...
    summary:
      "Led design and delivery of an OpenAI-powered writing platform for an edtech startup; owned backend architecture and integration with a focus on workflow speed and output quality.",
    tags: ["Python", "React", "OpenAI API", "REST APIs"],
    bullets: [
      "Architected multi-stage generation pipelines and REST endpoints.",
      "Delivered a modular Python + Flask microservice backend with a React front end.",
      "Ran iterative research and A/B tests to refine prompts and workflows.",
      "Implemented orchestration for chained API calls, streamlining the end-to-end writing process",
    ],
